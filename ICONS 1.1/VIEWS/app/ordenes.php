...
<body class="container-fluid">
    ...
    <div class="row pt-3 fixed-top bg-light">
        ...
        <div class="col-8 m-auto">
            ...
            <p>Documento de orden de compra</p>
        </div>
        <div class="col-1">
            <img src="../assets/imagenes/image-9.svg" alt="" style="width:100px">
        </div>
        <div class="col-1 m-auto">
            <div class="dropdown">
    ...
    <section class="row mt-5 pt-5 ms-4 mb-4 overflow-hidden no-wrap">
        <div class="col d-flex justify-content-between mb-3">
            <a href="crearOrden.php" class="btn btn-outline-primary">
                <img src="../assets/imagenes/add-icon.png" alt="" style="width:20px"> Crear orden
            </a>
            ...
            <ul class="dropdown-menu">
                <div class="p-3">
                    ...
                    <hr>
                    <form action="">
                        <label for="" class="form-label">Fecha de orden</label>
